...
png("plot4.png")
par(mfrow = c(2,2))
plot(y$wday_time, y$Global_active_power, type = "l", ylab = "Global Active Power")
plot(y$wday_time, y$Voltage, type = "l", ylab = "Voltage")
...
plot(y$wday_time, y$Global_reactive_power, type = "l", ylab = "Global_rective_power")
dev.off()
